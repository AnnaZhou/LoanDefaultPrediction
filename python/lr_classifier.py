...
svc = LinearSVC(C=0.01, penalty="l1", dual=False, verbose=2, class_weight={0: 1, 1: 2})
svc.fit(X_train, y_train)

# Features have been selected by SVM
X_train = svc.transform(X_train)
...
X_test = svc.transform(testdata(sys.argv[2]))
...
np.savetxt('predictions', y_prob, fmt='%d')
